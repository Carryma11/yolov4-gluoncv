...
from tools.dataset import voc_format as voc
...
def parse_args():
    ...
    parser.add_argument('--resume', type=str, default='yolo4_CSPDDarkNet53_voc_0000_0.0005.params',
    ...
    parser.add_argument('--save-prefix', type=str, default='yolo4_CSPDDarkNet53_voc',
...
def get_dataset(dataset, args):
    ...
    elif dataset.lower() == 'mydata':
        train_dataset = voc.VOCLike(root='VOCtemplate', splits=((2020, 'train'),))
        val_dataset = voc.VOCLike(root='VOCtemplate', splits=((2020, 'val'),))
        val_metric = VOC07MApMetric(iou_thresh=0.5, class_names=val_dataset.classes)
    else:
...
if __name__ == '__main__':
    ...
    if args.syncbn and len(ctx) > 1:
        ...
        net = yolo4_darknet53_voc(pretrained_base=False)
        #print(net)
        async_net = net
